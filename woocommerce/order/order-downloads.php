						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									echo "<div class='alm-account-download-product'>";
									$thumbnail = get_the_post_thumbnail($download['product_id'],'woocommerce_thumbnail');

									echo "<div class='alm-account-download-thumbnail'>";
									if ( $download['product_url'] ) {
										echo '<a href="' . esc_url( $download['product_url'] ) . '">' . $thumbnail . '</a>';
									}else{
										echo $thumbnail;
									}
									echo "</div>";

									echo "<div class='alm-account-download-name-category'>";
									echo "<div class='alm-account-download-name'>";
									if ( $download['product_url'] ) {
									...
									echo "</div>";
									echo wc_get_product_category_list($download['product_id'], '','<div class="alm-account-download-category">','</div>');
									echo "</div>";
									echo "</div>";
									break;
								case 'download-file':
