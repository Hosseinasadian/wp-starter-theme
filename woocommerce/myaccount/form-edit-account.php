...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<fieldset>
		<p class="alm-woocommerce-form-field form-row">
			<label for="password_current"><?php esc_html_e( 'گذرواژه پیشین', 'alma' ); ?></label>
			<input type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_current" id="password_current" autocomplete="off" />
		</p>
		<p class="alm-woocommerce-form-field form-row">
			<label for="password_1"><?php esc_html_e( 'گذرواژه جدید', 'alma' ); ?></label>
			<input type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_1" id="password_1" autocomplete="off" />
		</p>
		<p class="alm-woocommerce-form-field form-row">
			<label for="password_2"><?php esc_html_e( 'تکرار گذرواژه جدید', 'alma' ); ?></label>
